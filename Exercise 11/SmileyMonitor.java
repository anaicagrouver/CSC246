...
public class SmileyMonitor {
  ...
  private static class MyMonitor {
    ...
    private void printEyes( char sym ) throws InterruptedException {
      while (state != 0)
      monitor.wait();
    ...
    private void printNose( char sym ) throws InterruptedException {
      while (state != 1)
      monitor.wait();
      System.out.print(sym);
      state = 2;
    ...
    private void printMouth( char sym ) throws InterruptedException  {
			while (state != 2)
				monitor.wait();
